...
import NewReleasesSongItem from '../NewReleasesSongItem'

import './index.css'

class NewReleasesPlaySong extends React.Component {
  state = {
    ...this.props,
    index: 0,
    pause: false,
    ...
    return (
      <>
        <div className="playlist-container">
          ...
          {screenSize >= 768 && (
            <div className="columns-row-new" style={{width: '90%'}}>
              <p className="column-name">Track</p>
              <p className="column-name">Time</p>
              <p className="column-name">Artist</p>
            </div>
          )}
          <ul className="playlist-new">{this.renderSongsList()}</ul>
        </div>
...
export default NewReleasesPlaySong
